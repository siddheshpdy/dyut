...
const MoveSelector = ({ roll, validMoves, onFullMove, onSplitMove, onClose, onInitiatePairAttack, possiblePairAttacks }) => {
  ...
  if (isPartialRoll) {
    return (
      <div className="absolute z-20 bg-neutral-800 border-2 border-yellow-400 rounded-lg shadow-2xl p-4 flex flex-col gap-3 transform -translate-y-1/2 top-1/2 -right-48">
